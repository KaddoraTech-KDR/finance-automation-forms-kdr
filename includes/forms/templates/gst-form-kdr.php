...
<form class="fafkdr-form fafkdr-form--<?php echo esc_attr( $fafkdr_form_type ); ?>"
	...
	<div class="fafkdr-card">
		...
		<div class="fafkdr-field">
			...
			<input id="fafkdr_full_name" type="text" name="full_name" required>
		</div>

		<div class="fafkdr-field">
			<label for="fafkdr_email"><?php esc_html_e( 'Email *', 'finance-automation-forms-kdr' ); ?></label>
			<input id="fafkdr_email" type="email" name="email" required>
		</div>

		<div class="fafkdr-field">
			<label for="fafkdr_phone"><?php esc_html_e( 'Phone *', 'finance-automation-forms-kdr' ); ?></label>
			<input id="fafkdr_phone" type="tel" name="phone" placeholder="10 digit phone" required>
		</div>

		<div class="fafkdr-field">
			<label for="fafkdr_pan"><?php esc_html_e( 'PAN *', 'finance-automation-forms-kdr' ); ?></label>
			<input id="fafkdr_pan" type="text" name="pan" placeholder="AAAAA9999A" required>
			<span class="fafkdr-error" data-error-for="pan"></span>
		</div>

		<div class="fafkdr-field">
			<label for="fafkdr_aadhaar"><?php esc_html_e( 'Aadhaar (Optional)', 'finance-automation-forms-kdr' ); ?></label>
			<input id="fafkdr_aadhaar" type="text" name="aadhaar">
		</div>
	</div>
	...
	<div class="fafkdr-card">
		...
		<div class="fafkdr-field">
			...
			<select id="fafkdr_nature" name="nature" required>
		...
		<div class="fafkdr-field">
			...
			<input id="fafkdr_commencement" type="date" name="commencement">
		</div>
	</div>
	...
	<div class="fafkdr-card">
		...
		<div class="fafkdr-field">
			...
			<select id="fafkdr_country" name="country" required>
	...
	<div class="fafkdr-card">
		...
		<div class="fafkdr-field">
			...
			<input id="fafkdr_acc_holder" type="text" name="account_holder" required>
		</div>
		...
		<div class="fafkdr-field">
			...
			<input id="fafkdr_acc_no" type="text" name="account_number" required>
		</div>

		<div class="fafkdr-field">
			<label for="fafkdr_ifsc"><?php esc_html_e( 'IFSC *', 'finance-automation-forms-kdr' ); ?></label>
			<input id="fafkdr_ifsc" type="text" name="ifsc" required placeholder="e.g. HDFC0000123">
		</div>
	</div>
	...
	<div class="fafkdr-card">
		...
		<div class="fafkdr-field">
			...
			<input id="fafkdr_pan_card" type="file" name="pan_card" accept=".pdf,.jpg,.jpeg,.png">
		</div>

		<div class="fafkdr-field">
			<label for="fafkdr_address_proof"><?php esc_html_e( 'Address Proof (PDF/JPG/PNG)', 'finance-automation-forms-kdr' ); ?></label>
			<input id="fafkdr_address_proof" type="file" name="address_proof" accept=".pdf,.jpg,.jpeg,.png">
		</div>

		<div class="fafkdr-field">
			<label for="fafkdr_photo"><?php esc_html_e( 'Photo (JPG/PNG)', 'finance-automation-forms-kdr' ); ?></label>
			<input id="fafkdr_photo" type="file" name="photo" accept=".jpg,.jpeg,.png">
		</div>

		<div class="fafkdr-field">
			<label for="fafkdr_bank_proof"><?php esc_html_e( 'Bank Proof (PDF/JPG/PNG)', 'finance-automation-forms-kdr' ); ?></label>
			<input id="fafkdr_bank_proof" type="file" name="bank_proof" accept=".pdf,.jpg,.jpeg,.png">
		</div>
